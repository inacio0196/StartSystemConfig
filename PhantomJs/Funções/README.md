Funções são as ações que podem ser feitas com o programa phantomjs, criado para automatizar tarefas em navegadores através da linguagem de programação JavaScript.
